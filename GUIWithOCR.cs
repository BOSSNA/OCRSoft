...
namespace VietOCR.NET
{
    public partial class GUIWithOCR : VietOCR.NET.GUIWithImageOps
    {
     ...
     //       Rectangle rect = ((ScrollablePictureBox)this.pictureBox1).GetRect(); //a recorgnize in many area
            List<Rectangle> listRect = new List<Rectangle>();
            Rectangle rectHoten = new Rectangle(151,248,297,24);
            Rectangle rectLop = new Rectangle(113,338,152,26);
            Rectangle rectKhoa = new Rectangle(181,368,151,26);
            listRect.Add(rectHoten);
         //   listRect.Add(rectLop);
         //   listRect.Add(rectKhoa);

           
                try
                {
                    foreach(Rectangle irect in listRect)
                 //   rect = new Rectangle((int)(rect.X * scaleX), (int)(rect.Y * scaleY), (int)(rect.Width * scaleX), (int)(rect.Height * scaleY));
                        performOCR(imageList, inputfilename, imageIndex, irect);
                }
                catch (Exception ex)
                {
      ...
      //a  [System.Diagnostics.DebuggerNonUserCodeAttribute()]
        ...
        private void backgroundWorkerOcr_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                this.txtHoTen.Text = e.Result.ToString();
            }
