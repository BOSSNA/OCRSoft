...
namespace VietOCR.NET
{
    public partial class GUI : GUIWithRegistry
    {
        ...
        void loadImage(FileInfo imageFile)
        {
            ...
            //a    this.toolStripComboBoxPageNum.Enabled = true;
            //a    this.toolStripComboBoxPageNum.Items.Clear();
            /*a     for (int i = 0; i < imageTotal; i++)
                 {
        ...
        protected virtual void ChangeUILanguage(string locale)
        {
            ...
            //a    string totalPage = this.toolStripLabelPageNum.Text; 
            ...
            //a     this.toolStripLabelPageNum.Text = totalPage;
        }
        ...
        {
            //a  if (!this.toolStripComboBoxPageNum.Enabled) return;

            //a    int pageNum = Int32.Parse(this.toolStripComboBoxPageNum.SelectedItem.ToString());
            this.pictureBox1.Deselect();
            //a    imageIndex = pageNum - 1;
            this.toolStripStatusLabel1.Text = null;
            displayImage();
            clearStack();
        ...
        private void splitContainerImage_Panel2_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            listRect.Add(new Rectangle(151, 248, 297, 24));
            listRect.Add(new Rectangle(113, 338, 152, 26));
            listRect.Add(new Rectangle(180, 360, 200, 35));
            ...
            txtHoTen.Text = resultString[0];
            txtLop.Text = resultString[1];
            txtKhoa.Text = resultString[2];
